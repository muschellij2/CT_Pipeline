...
files = unlist(sapply(iddirs, function(x){
  list.files(x, recursive = FALSE, full.names=TRUE,
    pattern = ".*[.]nii")
  }))
names(files) = NULL
files = files[ !grepl("205-519_20110531_1140", files)]
...
fdf$roi = file.path(rootdir, "ROI_data", 
  fdf$id, fnames)
fdf$img = file.path(fdf$iddir, gsub("ROI\\.nii", ".nii", 
  fnames))
...
fdf$n3bias_field = gsub("_N3Correct", "_BiasField", 
  fdf$n3img)
fdf$n3ssbias_field= gsub("_N3Correct", "_BiasField", 
  fdf$n3ssimg)
...
ids = c("100-318", "100-362", "100-365", "101-306", 
  "101-307", "101-308", 
"102-317", "102-322", "102-323", "102-324", "102-331", 
"102-360", 
"102-367", "102-374", "102-391", "102-393", "102-403", 
"102-406", 
"120-376", "131-310", "131-316", "131-334", "131-354", 
"133-409", 
"133-417", "134-304", "134-305", "134-320", "134-327", 
"134-345", 
"134-380", "134-381", "134-382", "134-392", "134-408", 
"134-412", 
"134-416", "152-302", "152-303", "152-353", "157-328", 
"157-329", 
"157-332", "157-335", "157-336", "157-370", "157-372", 
"157-399", 
"157-410", "161-413", "173-312", "173-313", "173-325", 
"173-341", 
"173-361", "173-364", "173-368", "173-384", "173-396", 
"173-404", 
"175-387", "175-397", "175-405", "179-373", "179-383", 
"179-386", 
"179-394", "179-395", "179-402", "184-388", "191-301", 
"191-311", 
"191-314", "191-315", "191-319", "191-321", "191-333", 
"191-375", 
"191-400", "205-509", "205-517", "205-519", "216-390", 
"219-350", 
"222-337", "222-357", "222-358", "223-355", "223-369", 
"223-407", 
"225-502", "225-503", "225-504", "225-505", "225-506", 
"225-507", 
"225-510", "225-511", "225-515", "225-524", "230-356", 
"230-363", 
"230-366", "230-371", "230-377", "232-514", "232-516", 
"234-385", 
...
if (any(is.na(fdf$group))){
  stop("Something went wrong with group designation")
}
