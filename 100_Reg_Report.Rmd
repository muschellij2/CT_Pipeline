...
popimg = write.popimg(popimg, spm.popimg, rerun = rerun)
bin.popimg = write.popimg(bin.popimg, 
	spm.binimg, rerun = rerun)
...
cat.info = function(){
	for (iimg in seq(ids)){
		...
		nm = names(allreses)
		xtabs = vector(mode = "list", length=length(allreses))
		...
		cat(paste0("Reading Center location was: ", clot.loc, "\n"))
		aggxtab = xtable(agg)
